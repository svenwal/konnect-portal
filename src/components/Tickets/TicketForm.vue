<template>
    <KModal title="Raise a ticket" :is-visible="visible" text-align="left" class="ticketModal" @proceed="$emit('submitted')"
        ...
        <template v-slot:action-buttons>
            <KButton appearance="primary" @click="handleSubmit(formData)">Raise Ticket</KButton>
        </template>
    </Kmodal>
</template>
